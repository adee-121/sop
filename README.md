...
<body>
    <header>
        ...
        <div class="moving-text">
            🌟 استفد الآن من تخفيضات تصل إلى 70% على أفضل العقارات!
        </div>
        <div class="moving-text">
            🏠 احصل على بيتك الخاص بنظام التقسيط المريح وبدون فوائد.
        </div>
        <div class="moving-text">
            🌍 رؤيتنا: بناء مجتمع عقاري أفضل في اليمن.
        </div>
    </header>
